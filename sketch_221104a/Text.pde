...
void spaceBarText() {
  ...
  fill(brown); //Ink, hexidecimal copied from Color Selector
...
void quitButtonText() {
  ...
  color ink = (  nightMode==true  ) ? #D39344: brown ; //Note: hexidecimal example, only exists here
